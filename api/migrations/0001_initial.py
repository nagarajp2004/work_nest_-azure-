    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('designation_level', models.IntegerField(help_text='The level this permission rule applies to.', unique=True)),
                ('can_assign', models.BooleanField(default=False, help_text='Can users at this level assign tasks to lower levels?')),
                ('can_assign_to_same_level', models.BooleanField(default=False, help_text='Can users at this level assign tasks to users at the SAME level?')),
            ],
        ),
        migrations.CreateModel(
            name='User',
